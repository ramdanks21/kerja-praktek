  ...
  <body>
    <nav class="navbar  " role="navigation"  aria-label="main navigation">
        ...
        <div class="navbar-end">
          ...
          <div class="navbar-item">
             <a href="HOME" class="navbar-item">BOOKS</a>
            </div>
          <div class="navbar-item">
             <a   class="navbar-item" href="stdn-login.html">STUDENT-LOGIN</a>
            </div>
          <div class="navbar-item">
             <a href="HOME" class="navbar-item">ADMIN-LOGIN</a>
            </div>  
          <div class="navbar-item">
             <a href="HOME" class="navbar-item">ABOUT US</a>
            </div>
          </div>
        </div>
        </div>
